<?php
global $lista_productos,$listaProductosBuscador;
?>
   <!-- Estilos -->
...
<body>
    ...
    <header>
        ...
        <section id="barra_superior">
            ...
            ?>
                ...
                <form method="POST" action="">
                	<input type="submit" id="buscar" name="buscar" class="boton_carrito" value="Buscar"/>
                	<input type="text" name="buscador" id="buscador" placeholder="Buscar por nombre" class="boton_carrito"/>
    ...
    <main>
       ...
       if(isset($_POST["buscar"])){
           ...
           if(count($listaProductosBuscador)== 0){
               echo "Resultado  no encontrado";
           }else{
           foreach ($listaProductosBuscador as $codigo => $producto) {
