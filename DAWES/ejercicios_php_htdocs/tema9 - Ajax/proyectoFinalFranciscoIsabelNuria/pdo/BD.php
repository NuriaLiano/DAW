...
class BD
{
    ...
    function registrar($nombre_usuario, $hash_password, $foto)
    {
        ...
        $resulusuario = $conexion->query("SELECT usuario FROM usuarios WHERE usuario='$nombre_usuario'");

        
            if($resulusuario == $nombre_usuario){
    ...
    function eliminarComentariosUsuario($pro){
